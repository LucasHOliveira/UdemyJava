...
public class EmpregadoList_Aula96 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Entre com o número de profissionais que irá cadastrar: ");
		int funcionário = sc.nextInt();
		
		for(int i=0; i < funcionário; i++) {
		...
		System.out.print("Entre com o ID do funcionário que deseja realizar o aumento: ");
