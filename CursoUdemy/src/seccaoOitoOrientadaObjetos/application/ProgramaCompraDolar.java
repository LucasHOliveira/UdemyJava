...
/*
	...
	1º O valor atual do dolar
	2º Quantos dolares a pessoa de deve comprar
	3º Apresentar o valor em reais, levando em consideração 6% de IOF
...
public class ProgramaCompraDolar {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Valor do cotação utilizada U$ %.2f%n", v);
